...
import com.sherbin.springsecurity.model.PasswordModel;
...
public class RegistrationController {
   ...
   public  String resendVerififcationToken(@RequestParam("token")String oldToken, HttpServletRequest  request)
   {
